...
local viewq = http.request(Adamak_cp.."quran ("..target..").txt")
viewq = string.gsub(viewq, "Adamak", " ")
...
local qlist = http.request(Adamak_cp.."list.txt") 
qlist = string.gsub(qlist, "Adamak", "Adamak")
return qlist
end
end
